          ...
          {password.length > 0 && (
            <div className="af-strength">
              <div className="af-strength-bars">
                <div className={`af-strength-bar ${strength >= 1 ? 'weak' : ''}`} />
                <div className={`af-strength-bar ${strength >= 2 ? 'fair' : ''}`} />
                <div className={`af-strength-bar ${strength >= 3 ? 'strong' : ''}`} />
              </div>
              <span className="af-strength-label">
